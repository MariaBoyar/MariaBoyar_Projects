...
update dbo.Agencies set Agc_ParentCompany_ID = (select top 1 AGC_ID From dbo.Agencies where Agc_Name = 'ACF Insurance Services') where Agc_Name = 'Blackmon Insurance Agency of North Carolina, Inc' and AGC_Code = '85678'
...
update dbo.Agencies set Agc_ParentCompany_ID = (select top 1 AGC_ID From dbo.Agencies where Agc_Name = 'Brown Phillips Insurance') where Agc_Name = 'Direct Auto Insurance' and AGC_Code = '867858'
...
update dbo.Agencies set Agc_ParentCompany_ID = (select top 1 AGC_ID From dbo.Agencies where Agc_Name = 'Discovery Insurance Company') where Agc_Name = 'Direct Auto Insurance' and AGC_Code = '54677642'
...
update dbo.Agencies set Agc_ParentCompany_ID = (select top 1 AGC_ID From dbo.Agencies where Agc_Name = 'Direct Auto Insurance' and AGC_Code = '54677642') where Agc_Name = 'Amistad Insurance Services'
...
update dbo.Agencies set Agc_ParentCompany_ID = (select top 1 AGC_ID From dbo.Agencies where Agc_Name = 'Triangle Insurance Alliance') where Agc_Name = 'Blackmon Insurance Agency of North Carolina, Inc' and AGC_Code = '5756690'
